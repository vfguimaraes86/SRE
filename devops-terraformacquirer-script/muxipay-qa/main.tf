...
terraform {
  ...
  backend "s3" {
    ...
    profile        = "muxipay-dev"
    key            = "muxipay-qa/terraform.tfstate" #### TODO #### nome da pasta no buket ({NAMESPACE}/terraform.tfstate)
    region         = "us-east-2"
    encrypt        = true
...
module "enviroment" {
  ...
  namespace                       = "muxipay-qa"           #### TODO #### nome do namespace
  #force_destroy                   = true                   #### TODO #### se permite deletar secret e bucket instantaneamente (default false)
  domain                          = "qa"                   #### TODO #### dominio $http://{sub_domain}${"." + domain}.${route53.somain}
  ...
  */
  ...
  api_components = [
    ...
    {
      name       = "muxipay-integration-automation-poc"
      sub_domain = "poc-integration-automation"
    },
    {
